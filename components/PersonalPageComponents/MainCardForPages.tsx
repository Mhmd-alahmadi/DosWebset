...
export default function MainCardForPages() {
  ...
  return (
    ...
    <CardBody className='grid p-0 lg:grid-cols-2 grid-cols-1'>
        <div className="bg-bottom lg:mx-5 bg-contain bg-no-repeat bg-[url('/prsanilImg/mainCard.png')] w-full object-contain   lg:order-first order-last p-0 m-0 relative md:h-[70vh] h-[60vh]">
        </div>
        <div dir='rtl' className='"grid mt-5 lg:mt-0 justify-center content-center lg:grid-rows-2'>
            <h1 className={` text-center text-white 2xl:text-7xl xl:text-6xl lg:text-5xl  text-5xl xl:px-20 lg:px-10 px-10 `}>
          جيب تفهمك وتنفذ احتياجاتك
            </h1>
            ...
            تخيل أن كل احتياجاتك الأساسية والترفيهية موجودة على تطبيق جيب بصورة مسهلة وواضحة ومطورة كالتالي:            </p>
        </div>
    </CardBody>
  </Card>
  <div className="relative invisible lg:visible container-fluid mt-3 mb-10 flex justify-around  ">
        <div className="w-14 ">
          <Link href="#Moneytransfers" onClick={handleScroll}>
