...
export default function MainCardForPages() {
  ...
  return (
    ...
    <CardBody className='grid p-0 lg:grid-cols-2 grid-cols-1'>
        <div className="bg-bottom lg:mx-5 bg-contain bg-no-repeat bg-[url('/GuideImg/mainCard.png')] w-full object-contain   lg:order-first order-last p-0 m-0 relative md:h-[70vh] h-[60vh]">
        </div>
